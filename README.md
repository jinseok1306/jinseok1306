## 보안 개발자 박진석입니다. 
더 나은 보안 개발자가 되기 위해 날마다 공부하는 평범한 직장인입니다.
...
6. 내 개발스킬을 기준으로 시스템 구현이 힘들다고 말하지 말자.
